    ...
    <div className="flex flex-row relative items-center justify-center min-h-screen w-full h-full mt-[-60px]">
      <div className="absolute w-auto h-auto top-0 z-[5] ">
        <motion.div
          ...
          className="text-[40px] font-medium text-center text-gray-200 mt-[100px]"
        >
          Performance
      ...
      <div className="absolute z-[20] bottom-[10px] px-[5px]">
        <div className="cursive text-[20px] font-medium text-center text-gray-300 mt-[-200px] md:mt-[400px]">
