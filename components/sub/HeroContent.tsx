    ...
    >
        <div className="h-full w-full flex flex-col gap-5 justify-center m-auto text-start">
            ...
            >
              <span>
                Oferecendo a
                <span className='text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500'> melhor experiência </span>
                de projeto
              </span>
            </motion.div>
        ...
        <motion.div
            ...
            className='w-full h-full invisible sm:visible flex justify-center items-center'
            >
                <Image 
